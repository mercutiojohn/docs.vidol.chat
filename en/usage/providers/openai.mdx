...
title: Using OpenAI
description: >-
  This document will guide you on how to configure and use OpenAI's AI model
  services in LobeVidol. OpenAI offers some of the most advanced language models
  available today, including the GPT-4 and GPT-3.5 series.
