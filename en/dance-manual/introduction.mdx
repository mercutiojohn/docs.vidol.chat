...
- MMD dance files are usually meticulously crafted by enthusiasts or generated using motion capture devices.
...
- The MMD community has a wealth of dance file resources available on Bilibili or specialized model websites.

## Further Reading

For a deeper understanding of MMD, we recommend reading:

<Card title="A Brief Discussion on the Development of MMD" icon="book" href="https://www.gcores.com/articles/23767">
  This article provides a detailed overview of the development history and current status of MMD.
</Card>
