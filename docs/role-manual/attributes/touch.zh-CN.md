...
keywords: 触摸反应, 角色, 身体部位, 反应
icon: hand-wave
---

## 前言

在系统配置中，我们默认根据性别定义了一套通用的角色触摸反应。用户在与角色互动的过程中，触摸到特定部位，如头部、胸部、臀部、腹部、腿部等身体部位时，角色所采取的反应包括表情、动作、文案等。你可以根据需要修改这些预设，也可以开启`启用自定义触摸`功能来自定义触摸反应。
...
在区域上方是`启用自定义触摸`功能的开关，默认情况下是关闭的。关闭情况下，系统默认会采用系统预设的触摸定义反应。你可以在`系统设置` -> `触摸设定`中修改预设：
