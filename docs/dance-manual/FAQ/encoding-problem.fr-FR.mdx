---
title: >-
  Résoudre le problème de caractères illisibles lors de la décompression de
  fichiers japonais
description: >-
  Comment résoudre le problème de caractères illisibles lors du téléchargement
  de fichiers zip sur des sites étrangers
keywords: 'décompression, caractères illisibles, japonais, zip, fichier compressé'
icon: question
---
...
<Frame caption="Exemple de caractères illisibles après décompression">
  ![Problème de décompression](https://oss.vidol.chat/compression-problem.png)
</Frame>
...
<Steps>
  <Step title="Ouvrir Bandzip">
    Lancez le logiciel Bandzip.
  </Step>
  <Step title="Configurer la page de code par défaut">
    Dans les paramètres de Bandzip, trouvez l'option de page de code par défaut.
  </Step>
  <Step title="Choisir la langue appropriée">
    Réglez la page de code par défaut sur le japonais (ou une autre langue appropriée).
  </Step>
</Steps>

<Frame caption="Interface de configuration de Bandzip">
  ![Paramètres de Bandzip](https://oss.vidol.chat/bandzip.png)
</Frame>
...
<Frame caption="Noms de fichiers correctement décompressés">
  ![Résultat de décompression normal](https://oss.vidol.chat/compression-normal.png)
</Frame>
