...
description: >-
  Le fichier VMD (Vocaloid Motion Data) est un format de fichier important
  utilisé dans MikuMikuDance (MMD) pour stocker des données d'animation.
keywords: >-
  VMD, Vocaloid Motion Data, MikuMikuDance, MMD, données d'animation, format de
  fichier
icon: file-video
---
